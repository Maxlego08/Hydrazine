	...
	public void start() {
		...
		client.getSession().setFlag(MinecraftConstants.SERVER_INFO_HANDLER_KEY, new ServerInfoHandler() {
			...
			public void handle(Session session, ServerStatusInfo info) {
				System.out.println(Hydrazine.infoPrefix + "Version: " + info.getVersionInfo().getVersionName()
						+ ", Protocol Version: " + info.getVersionInfo().getProtocolVersion());
				System.out.println(Hydrazine.infoPrefix + "Player Count: " + info.getPlayerInfo().getOnlinePlayers()
