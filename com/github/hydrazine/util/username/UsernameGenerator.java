...
public class UsernameGenerator {
	...
	public UsernameGenerator() {
		/*
		 * Minecraft usernames: - min length: 3 - max length: 16 - allowed
		 * chars:
	 ...
	 * 
	 * @param length
	 *            The desired length the username should have
	...
	public String generateNatural() {
		String[] parts1 = { "Hero", "Player", "Fighter", "Flame", "Hunter", "Alpha", "Slayer", "Creeper", "Creator",
				"Spider" }; // Word length: 3-7
		String[] parts2 = { "Maker", "Boss", "Killer", "Builder", "Star", "Friend", "Enemy", "Smoke", "Shadow",
				"Miner" }; // Word length: 3-7
	...
	public String constantUsername(String username) {
		...
		if (len < 3 || len > 15) // 15 because we have to add at least one char
									// to the username
		{
			...
			for (int i = 0; i < a; i++) {
				sb.append(r.nextInt(10)); // Appending random numbers until
											// we've reached 16 chars
			}
